...
summary = {
    "benchmark": "controlled_near_rim_lateral_displacement_recovery_v1",
    ...
    "episodes": a.episodes,
    "perturbation_definition": f"radius uniform [{a.perturb_min}, {a.perturb_max}] m; angle uniform [-pi, pi]; held_root_z-hole_root_z={a.initial_depth} m",
